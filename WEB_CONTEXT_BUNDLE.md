...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-049"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-v1",
      "problem_contract_sha256": "b393fb8840c81f7e2080907d0e9a1081837b95bf97a9178b1a54b1cdb9207c85",
      "problem_id": "problem:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e",
      "route_id": "route:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-source-fidelity-01",
      "graph_id": "graph:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A$ be a set of $n$ points in the plane. Can one select $A' \\subset A$ of size $n/2$ such that any axis-parallel rectangle containing 1000 points of $A$ contains at least one point of $A'$?"
          },
          "statement_sha256": "0a5e09be426cf2e050b49c49a8903639a3b382f1343e672bd1cbbff3b455ab0b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-root",
      "route_id": "route:um-green-049-sparse-hitting-set-for-rectangles-ee78d95e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-049-e659a0cfc40a",
        "url": "https://www.unsolvedmath.com/problems/GREEN-049"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
